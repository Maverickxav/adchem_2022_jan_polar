module monomer_settingsAMsD

use acdc_systemAMsD, only : neq, nclust, n_mol_types, monomer_indices
use acdc_systemAMsD, only : n1A, n_1A_clusters, clusters_with_1_A

implicit none

contains

subroutine sources_and_constantsAMsD(source,isconst,fitted,ipar)
	implicit none
...
end subroutine sources_and_constantsAMsD
