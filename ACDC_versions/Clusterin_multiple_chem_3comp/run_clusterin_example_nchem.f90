...
! use acdc_simulation_setup_2, only : get_system_size_2
    ...
    real(kind(1.d0)) :: j_acdc_N, j_acdc_D, j_acdc_I, j_acdc_total                                      ! Simulated total formation rate (m^-3 s^-1)
    ...
    integer, parameter :: n_spec_example = 5
    ...
    output_dir='/Users/carlton/Work/ACDC_versions/Clusterin_multiple_chemistries/ClusterIn/ClusterIn_plugin_3comp/output'
    ...
    names_vapor_all(3)(:) = 'N'
    names_vapor_all(4)(:) = 'D'
    names_vapor_all(5)(:) = 'Ms'
    ! names_vapor_all(6)(:) = 'Io'
    c_vapor_all = (/1.d10, 2.d6, 1.d9, 1.d6, 1.d6/)*1.d6
...
!-----------------------------------------------------------------------------------
    ...
    OPEN(10012,FILE=trim(adjustl(output_dir))//'/Jnucl_total.dat',STATUS='REPLACE',ACTION='WRITE')
    l_dynamic = .true.
...
!-----------------------------------------------------------------------------------
    ...
    do it = 1,2
        ...
        if (l_dynamic) then
            ...
            nmols_evap_all = (/2.d0, 5.d0, 5.d0, 1.d0,  2.d0/)
        ...
        write(10013,*) j_acdc_I*1d-6
        write(10012,*) (j_acdc_N + j_acdc_D + j_acdc_I)*1d-6
        t = t + time_res
