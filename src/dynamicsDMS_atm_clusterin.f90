...
END SUBROUTINE sea_spray                   
    ...
    ! Coagulation                                          !
    !------------------------------------------------------!
SUBROUTINE coagulation_clusterin(N_bins,V_bins,c_p,c_p_backg,d_p,dp_dry,dt,dens_p,MX,qX,chem_1,chem_2,n_clustering_vapors)
  ...
  !! for cluster 
  type(clustering_mod), intent(in):: chem_1, chem_2
