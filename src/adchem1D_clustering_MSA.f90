...
! *******************************************************************************************************************************
	...
	EmissionI2=O3_ppb*(Iion_aq**1.3)*(1.74D9-6.54D8*LOG(windspeed(tr)))*1D-4*1D-9*Na/(24D0*3.6D3) ! molec cm^-2 h^-1
	EmissionHOI=O3_ppb*SQRT(Iion_aq)*(3.56D5/windspeed(tr)-2.16D4)*1D-4*1D-9*Na/(24D0*3.6D3) ! molec cm^-2 h^-1
