...
integer, parameter :: nout_neu = 71, nout_neg = 72, nout_pos = 73
...
integer, parameter :: n_negatives = 23			! number of negative molecules and clusters
integer, parameter :: n_positives = 18			! number of positive molecules and clusters
...
integer, parameter :: n_negative_clusters = 21			! number of negative clusters
integer, parameter :: n_positive_clusters = 16			! number of positive clusters
...
integer, parameter :: nmols_out_negative(1, 4) = reshape((/6, 1, 0, 3/),(/1, 4/))			! criteria for outgrowing negatives
integer, parameter :: nmols_out_positive(1, 4) = reshape((/6, 0, 1, 7/),(/1, 4/))			! criteria for outgrowing positives
...
subroutine monomer_arrays(neutral_monomers, negative_monomers, positive_monomers)
	...
	neutral_monomers = (/1, 4/)
	negative_monomers = (/25/)
	positive_monomers = (/47/)
