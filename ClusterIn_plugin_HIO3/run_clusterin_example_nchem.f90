...
! use acdc_simulation_setup_2, only : get_system_size_2
    ...
    integer, parameter :: n_spec_example = 6
    ...
    output_dir='/Users/carlton/Work/Clusterin_multiple_chemistries/ClusterIn/ClusterIn_plugin/output'
    ...
    c_vapor_all = (/1.d10, 2.d6, 1.d9, 1.d6, 1.d5, 1.d6/)*1.d6
...
!-----------------------------------------------------------------------------------
    ...
    OPEN(10013,FILE=trim(adjustl(output_dir))//'/Jnucl_I.dat',STATUS='REPLACE',ACTION='WRITE')
...
!-----------------------------------------------------------------------------------
    ...
    do it = 1,2
        ...
        if (l_dynamic) then
            ...
            nmols_evap_all = (/2.d0, 5.d0, 5.d0, 1.d0,  2.d0, 2.d0/)
