...
!¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤
	   ...
	   SUBROUTINE GAMME_CE(JDATE,JTIME,NCLOS,NROWS,LAT, LONG,PPFD0,Tc,LAI,Wind,Pres,Humidity,DI,  &
                           Cantype,PFTF,Canopychar,NrCha,NrTyp,NPFT, Ealt,Ealp, Ealpt, LAdp, midpoint,    &
                           Layers, gammasout, sun_par, Sunleaftk, Shadeleaftk, Sunfrac)
	   ...
	   REAL, DIMENSION(NCLOS,NROWS) :: Pres, LAI, DI,PPFD
       REAL, DIMENSION(NCLOS,NROWS) :: PPFD0
       REAL, DIMENSION(NrCha,NrTyp) :: Canopychar             ! Array of canopy characteristics for NrTyp of canopy type
       

	   REAL LONG(NCLOS,NROWS),Hour(NCLOS,NROWS)


       REAL :: Beta
       REAL,DIMENSION(NCLOS,NROWS) :: Lat,Sinbeta
       REAL,DIMENSION(NCLOS,NROWS,Layers) ::  VPgausWt, VPgausDis, VPslwWT, Sunfrac, QdAbsV, QsAbsV, QdAbsn,           &  
       ...
       REAL, DIMENSION(NCLOS,NROWS) :: Solar, Maxsolar, Transmis,Difffrac, PPFDfrac, QbAbsn, Trate, StomataDI, Qbeamv, &
       ...
       REAL, DIMENSION(NPFT,NCLOS,NROWS)::  Ealpt,PFTF,Ealt,Ealp
                       
       REAL::  DIstomata, CalcEccentricity,WaterVapPres, Stability, Ea1t99, Ea1p99,Calcbeta


       INTEGER, INTENT(in) ::  Cantype

       REAL, DIMENSION(Layers)     :: LADp, midpoint, sun_par
       REAL, DIMENSION(Layers+1)   :: Tc, Wind, Humidity !tempreature, wind, humidity
       REAL, DIMENSION(3,4,Layers) :: gammasout ! gamma factors bundled

       TairK(1,1,:) = Tc( 1 : Layers ) 
       ...
       DO I = 1, NCLOS
          DO J = 1, NROWS
             Hour(I,J) = JTIME/10000 !+ LONG(I,J)/15   ! Solar hour ( input gives solar hour)
             ...
             ENDIF
             Beta=Calcbeta(Day(I,J), Lat(I,J), Hour(I,J))            
       ...
       !DO K = 2, 2
        ...
        !        Cantype (i,j) = 1
	      ...
	      Call CanopyRad(VPgausDis, Layers, LAI, Sinbeta, Qbeamv, Qdiffv, Qbeamn, Qdiffn,Cantype ,Canopychar, Sunfrac, &
		  ...
		  DO I=1, NCLOS
             DO J=1, NROWS
                ...
                Trate(I,J)   =  Stability(Canopychar, Cantype, Solar(I,J), NrCha, NrTyp)
             ENDDO
          ENDDO
		  ...
		  DO I=1, NCLOS
             DO J=1, NROWS
                ...
                DO II = 1, Layers
                   ...
                   SH(I,J)           = SH(I,J) + (SunleafSH(I,J,II) * Sunfrac(I,J,II) + ShadeleafSH(I,J,II) * (1 - Sunfrac(I,J,II))) * &
                                       LAI(I,J) * VPgausWt(I,J,II)

                   Ea1Layer(I,J,II)  = Ea1t99(Sunleaftk(I,J,II), Td)   * Ea1p99(VPgausDis(I,J,II) * LAI(I,J), SunPPFD(I,J,II))   * Sunfrac(I,J,II) + & 
                                       Ea1t99(Shadeleaftk(I,J,II), Td) * Ea1p99(VPgausDis(I,J,II) * LAI(I,J), ShadePPFD(I,J,II)) * (1 - Sunfrac(I,J,II))
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
       ...
       SinDelta = -SIN(0.40907) * COS(6.28 * (REAL(Day) + 10.) / (365.))
       ...
       Calcbeta = (Pi/2.-ASIN(Sinbeta)) * 57.29578
       IF (Calcbeta>90.) Calcbeta=90.
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
        ...
        REAL, DIMENSION(NCLOS,NROWS) :: LAI
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
        ...
        REAL ,DIMENSION(NCLOS,NROWS) :: Solar, Maxsolar, Transmis, FracDiff, PPFDfrac
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
        ...
        REAL :: Sb, ScatV, ScatN, RefldV, RefldN, ReflbV, &
                ReflbN,Kb, Kd, KbpV, KbpN, KdpV, KdpN, LAIdepth, &
                Cluster, ConvertPPFD,QdAbsVL, QsAbsVL, QdAbsNL, &
                QsAbsNL, QqV, Qqn
                                        
        REAL,DIMENSION(NCLOS,NROWS,Layers) ::  Distgauss, &
                      Sunfrac,QdAbsV, QsAbsV, QdAbsn, QsAbsn, SunQv, &
                      ShadeQv, SunQn, ShadeQn, SunPPFD, ShadePPFD


        REAL, DIMENSION(NCLOS,NROWS) :: Solar, Maxsolar, PFTP, &
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
        ...
        REAL :: Qbeam, scat, Kb, Kd, Reflb, Kbp, Kdp, &
               QbeamAbsorb, P
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
       ...
       Dens001 = Dens * 0.001 !uncommented rusan
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
        ...
        INTEGER, PARAMETER :: real_x = SELECTED_REAL_KIND(p=14, r=30)
         ...
         REAL :: Cdepth, Lwidth, Llength, Cheight, Eps, &
                  ...
                  IRin,IRout, UnexposedLeafIRin, ExposedLeafIRin
        ...
        REAL, DIMENSION(NCLOS,NROWS) ::  Trate, StomataDI, &
       ...
       ! Shade
       CALL LeafEB(ShadePPFD(I,J,II), ShadeQv(I,J,II) &
              + ShadeQn(I,J,II), &
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
       ...
       REAL, PARAMETER ::  Sb    = 5.67051e-8        ! Boltzman constant (W/m2/K4)
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
       ...
       INTEGER, PARAMETER :: real_x = SELECTED_REAL_KIND(p=14, r=30)
       REAL :: Sb, Tk, HumidPa, EmissAtm, ExposedLeafIRin
