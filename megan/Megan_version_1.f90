...
!oooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
  ...
  SUBROUTINE EMISSION_M1(TairK, PAR, Wind, layers, day, HumidairPa, LAI, BETA, time, s2, k_canopy, z,                &
    ...
    REAL, PARAMETER ::                             &
         ...
         !ConvertWm2toUmolm2s = 4.55,               &           ! Get total solar radiation (W m-2) from par (umol m2 s)
         ConvertWm2toUmolm2s = 4.766                           ! Convert radiation from [W/m2] to [umol/m2/s1] - new megan

    REAL, SAVE, DIMENSION(NrCha,NrTyp) :: Canopychar                     ! Array of canopy characteristics for NrTyp of canopy type
    REAL, SAVE, DIMENSION(1106,5)      :: SEP_janne                      ! Standard emission potential monoterpenes and others for one 12 days by Janne
    REAL, DIMENSION(366,22)            :: EFin                           ! Standard emission potential monoterpenes and others each day

!    REAL, DIMENSION(NrCha,NrTyp) :: Canopychar                     ! Array of canopy characteristics for NrTyp of canopy type
!    REAL, DIMENSION(366,15)      :: SEP                            ! Standard emission potential monoterpenes and others each day
!    REAL, DIMENSION(1106,5)      :: SEP_janne                      ! Standard emission potential monoterpenes and others for one 12 days by Janne

    REAL                         :: LAI, emi_factor, emi_par, &
             ISO_EMI, MBO_EMI, MYR_EMI, SAB_EMI, LIM_EMI, CAR_EMI, OCI_EMI, BPI_EMI, API_EMI, FAR_EMI, BCA_EMI, & 
	         MET_EMI, ACT_EMI, ACA_EMI, FOR_EMI, CH4_EMI, NO_EMI,  OMT_EMI, OSQ_EMI, CO_EMI,  LIN_EMI, CIN_EMI

    REAL, DIMENSION(k_canopy)    :: VPgausWt, VPgausDis, VPslwWT, QdAbsV, QsAbsV, QdAbsn,    &
         ...
         s2, Wind, sun_par, Sunfrac

    REAL, DIMENSION(Layers)      :: z, Ea1pLayer, Ea1tLayer, Ea1Layer, Emethanol, Ea1pLayer_new, Ea1tLayer_new, Ea1Layer_new, Ea1NLayer_new, Emethanol_new, sun_par_new

    REAL, DIMENSION(Layers,22) :: EMI
    REAL, DIMENSION(k_canopy)    :: midpoints !Layer centerpoints for gamme_CE

    REAL :: Sinbeta, PAR, Solar, Maxsolar, Transmis, Difffrac, PPFDfrac, QbAbsn, Trate, StomataDI, Qbeamv, & 
    ...
    IF (time .EQ. 60.0) THEN
       ...
       DO JJ = 1,16
          READ(4,*) (Canopychar(JJ,II), II = 1, 7)
       ENDDO
       CLOSE(4)
    ENDIF
    ...
    MYR_EMI = EFin(Day,3)  * 1E-9 / 3600 * 0.0538
    SAB_EMI = EFin(Day,4)  * 1E-9 / 3600 * 0.0538
    LIM_EMI = EFin(Day,5)  * 1E-9 / 3600 * 0.0538
    CAR_EMI = EFin(Day,6)  * 1E-9 / 3600 * 0.0538
    OCI_EMI = EFin(Day,7)  * 1E-9 / 3600 * 0.0538
    BPI_EMI = EFin(Day,8)  * 1E-9 / 3600 * 0.0538
    API_EMI = EFin(Day,9)  * 1E-9 / 3600 * 0.0538
    OMT_EMI = EFin(Day,18) * 1E-9 / 3600 * 0.0538
    FAR_EMI = EFin(Day,10) * 1E-9 / 3600 * 0.0538
    BCA_EMI = EFin(Day,11) * 1E-9 / 3600 * 0.0538
    OSQ_EMI = EFin(Day,19) * 1E-9 / 3600 * 0.0538
    MBO_EMI = EFin(Day,2)  * 1E-9 / 3600 * 0.0538
    MET_EMI = EFin(Day,12) * 1E-9 / 3600 * 0.0538
    ACT_EMI = EFin(Day,13) * 1E-9 / 3600 * 0.0538
    CH4_EMI = EFin(Day,16) * 1E-9 / 3600 * 0.0538
    NO_EMI  = EFin(Day,17) * 1E-9 / 3600 * 0.0538
    ACA_EMI = EFin(Day,14) * 1E-9 / 3600 * 0.0538
    FOR_EMI = EFin(Day,15) * 1E-9 / 3600 * 0.0538
...
!oooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
    ...
    REAL :: Pi, Rpi, Rpi180, Hour, Lat, SinDelta, CosDelta, A, B, Sinbeta, Calcbeta
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
    ...
    REAL :: DIhigh, DIlow, DIstomata, DI
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
    ...
    REAL, DIMENSION(k_canopy) :: Weightgauss, Distgauss
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
    ...
    REAL :: Solar, Maxsolar, Transmis, FracDiff, PPFDfrac, TransMin, TransSlope
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
    ...
    REAL :: SLWsum, RealII, LAI

    REAL, DIMENSION(k_canopy) :: Distgauss, Weightgauss, SLW
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
    ...
    REAL, DIMENSION(k_canopy) :: Sunfrac, ShadePPFD, SunPPFD, Qdabsv, Qsabsv, Qsabsn, Shadeqv,        &
	                                   SunQn, Distgauss, QdAbsn, SunQv, ShadeQn 

    REAL :: ScatV, ScatN, RefldV, RefldN, ReflbV, ReflbN, Kb, Kd, KbpV, KbpN, KdpV, KdpN,           &
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
    ...
    INTEGER, PARAMETER :: real_x = SELECTED_REAL_KIND(p=14, r=30)  
    REAL :: Qbeam, scat, Kb, Kd, Reflb, Kbp, Kdp, QbeamAbsorb, P
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
    ...
    INTEGER, PARAMETER :: real_x = SELECTED_REAL_KIND(p=14, r=30)  
    REAL :: Qdiff, Qbeam, kdp, kbp, kb, scat, refld, reflb, LAIdepth, QbAbs, QdAbs, QsAbs
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
    ...
    INTEGER, PARAMETER :: real_x = SELECTED_REAL_KIND(p=14, r=30)  
    REAL :: Dens, Dens001, Pres, WaterVapPres, WaterAirRatio
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
    ...
    REAL :: 	Cdepth, Lwidth, Llength, Cheight, Eps, TranspireType, Deltah,            &
	                    IRin, Trate, IRout, StomataDI  !,                              & 
                      !  UnexposedLeafIRin, ExposedLeafIRin

    REAL, DIMENSION(k_canopy) :: Distgauss, TairK, HumidairPa, Ws, SunPPFD, SunQv, SunQn, SunleafIR,    &
    ...
    DO II = 1, k_canopy
       ...
       ! Sun
       CALL LeafEB(SunPPFD(II), SunQv(II) + SunQn(II), SunleafIR(II), Eps, TranspireType, Lwidth, Llength,           &
	               TairK(k_canopy+1-II), HumidairPa(k_canopy+1-II), Ws(II), Sunleaftk(II), SunleafSH(II), SunleafLH(II), IRout, StomataDI)
       ...
       CALL LeafEB(ShadePPFD(II), ShadeQv(II) + ShadeQn(II), ShadeleafIR(II), Eps, TranspireType, Lwidth, Llength,   &
	               TairK(k_canopy+1-II), HumidairPa(k_canopy+1-II), Ws(II), Shadeleaftk(II), ShadeleafSH(II), ShadeleafLH(II), IRout, StomataDI)
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
    ...
    REAL, PARAMETER ::  Sigma1    = 5.67051e-8        ! Boltzman constant (W/m2/K4)
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
    ...
    REAL :: PPFD, Q, IRin, Eps, TranspireType, Lwidth, Llength, TairK, HumidairPa, Ws, Tleaf, SH, LH, IRout, StomataDI,  &
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
    ...
    INTEGER, PARAMETER :: real_x = SELECTED_REAL_KIND(p=14, r=30)  
    REAL :: Tleaf, Ambvap, LatHv, GH, StomRes, TranspireType, LeafRes, Vapdeficit, LeafLE, LE
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
    ...
    INTEGER, PARAMETER :: real_x = SELECTED_REAL_KIND(p=14, r=30)  
    REAL :: PPFD, Alpha, C1, Ea1p99, LAI2
