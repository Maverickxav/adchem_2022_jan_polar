...
yCl,yCH3SO3,pCO2,mH,fHSO4,fSO4,fNO3,fCl,fCH3SO3,fNH4,mHCO3,mCO3,mOH)

REAL(dp), INTENT(in) :: mNV,mNIII,mSVI,mClI,mNa,mCH3SO3I,T,yH,yHSO4,ySO4,&
yNH4,yNO3,yCl,yCH3SO3,pCO2
REAL(dp), INTENT(out) :: mH,fHSO4,fSO4,fNO3,fCl,fCH3SO3,fNH4,mHCO3,mCO3,mOH
REAL(dp) :: Kw,K1,K2,K4,K5,K6,H_NH3,KNH3,KHCl,KCH3SO3H,KHNO3,Ka,yHCO3,yCO3,yOH,yCOO,&
...
Kw=1D-14 ! H2O <-> OH- + H+ 
K1=1.015D-2*EXP(8.85*(298.15/T-1D0)+25.14*(1D0+LOG(298.15/T)-298.15/T)) ! equilibrium constant HSO4- <-> H+ + SO42-
K2=1.03D11*EXP(34.81*(298.15/T-1D0)-5.39*(1D0+LOG(298.15/T)-298.15/T)) ! equilibrium constant NH3(g)+H+ <->NH4+
K4=3.4D-2 ! atm^-1 Henrys constant for CO2
K5=4.3D-7 ! H2CO3<->HCO3- + H+
K6=4.7D-11 ! HCO3- <-> Co32- + H+

H_NH3=57.6*EXP(13.79*(298.15/T-1D0)-5.39*(1D0+LOG(298.15/T)-298.15/T)) ! mol/(kg atm) NH3(g)<->NH3(aq)
KNH3=K2/H_NH3 ! kg/mol NH3(aq)+H+<->NH4+
KHCl=1.72D6*EXP(23.15*(298.15/T-1D0)) ! mol/kg HCl(aq)<->H+ + Cl-
KCH3SO3H=855.0667*EXP(1980.5*(1D0/T-1D0/298.15D0))  !10**(2.932)*T_factor ! COSMOtherm
